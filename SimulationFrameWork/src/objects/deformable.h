...
namespace HINASIM
{
    ...
    protected: // disabled constructors
        explicit DeformableObject(Eigen::Vector3d position = {0, 0, 0}, Eigen::Vector3d rotation = {0, 0, 0}, Eigen::Vector3d scale = {1, 1, 1});
    ...
    {
    public:
        Cloth(int rows, int cols, int width, int height, Eigen::Vector3d position = {0, 0, 0}, Eigen::Vector3d rotation = {0, 0, 0}, Eigen::Vector3d scale = {1, 1, 1});
