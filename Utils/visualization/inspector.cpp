...
void pbd_inspector::Inspector::plot(const char *label, float start_pos_x, float start_pos_y, float width, float height)
{
...
void pbd_inspector::ScalarTimeValueInspector::plot(const char *label, float start_pos_x, float start_pos_y, float width, float height)
{
