...
#ifndef POSITIONBASEDDYNAMICS_PICK_NEAREST_VERTICES_H
#define POSITIONBASEDDYNAMICS_PICK_NEAREST_VERTICES_H
...
#endif //POSITIONBASEDDYNAMICS_PICK_NEAREST_VERTICES_H
